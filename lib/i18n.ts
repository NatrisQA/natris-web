...
export const content = {
  ...
  hero: {
    ko: {
      ...
      sub: "소셜 포커, 방송 인터랙티브 미니게임, 소모임·대회 운영, 지식 플랫폼, AI 솔루션. 플레이어가 모이는 모든 접점을 잇습니다.",
      cta: "서비스 보기",
      cta2: "제휴 문의",
    ...
    en: {
      ...
      sub: "Social poker, broadcast interactive mini-games, clubs and tournament operations, knowledge platforms, AI solutions. We connect every touchpoint where players gather.",
