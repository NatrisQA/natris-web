...
export const content = {
  ...
  about: {
    ko: {
      ...
      milestones: [
        { date: "2025.Q2", text: "LULU x nIGHTSHIFT Pub 대회 개최" },
        { date: "2025.Q3", text: "법인 설립" },
        { date: "2026.Q2", text: "APL x LULU POKER FESTIVAL 대회 후원" },
        { date: "2026.Q3", text: "LinkPlay 소프트 런칭" },
      ],
    },
    en: {
      label: "ABOUT",
      ...
      milestones: [
        { date: "2025.Q2", text: "LULU x nIGHTSHIFT Pub Tournament" },
        { date: "2025.Q3", text: "Incorporated" },
        { date: "2026.Q2", text: "APL x LULU Poker Festival Sponsorship" },
        { date: "2026.Q3", text: "LinkPlay Soft Launch" },
      ],
    },
  },
    ...
    items: [
      {
        ...
        aboutCopy: {
          ko: "단순한 게임을 넘어\n포커를 문화로 만드는 일\n온·오프라인을 잇는 포커 생태계를 짓습니다",
          en: "More than just a game,\nturning poker into a culture,\nbuilding an ecosystem that bridges online and offline",
        },
        ...
        features: [
          {
            ...
            image: "/images/pokerlulu/feature-social.png",
          },
          {
            icon: "🏆",
            ...
            image: "/images/pokerlulu/feature-tournament.png",
          },
          {
            icon: "📺",
            ...
            image: "/images/pokerlulu/feature-live.png",
          },
          {
            icon: "🔀",
            ...
            image: "/images/pokerlulu/feature-onoff.png",
          },
        ],
        ...
        features: [
          {
            ...
            image: "/images/linkplay/feature-realtime-matching.png",
          },
          {
            icon: "🎙",
            ...
            image: "/images/linkplay/feature-creator-integration.png",
          },
          {
            icon: "👥",
            ...
            image: "/images/linkplay/feature-viewer-participation.png",
          },
          {
            icon: "🎮",
            ...
            image: "/images/linkplay/feature-minigames.png",
          },
        ],
        gallery: [null, null, null] as (string | null)[],
      },
      {
        ...
        name_ko: "투베루루",
        desc: {
          ko: "전문가를 구독하고 인사이트를 읽고 직접 질문까지,\n지식과 팬덤이 만나는 새로운 교류 공간",
          en: "Subscribe to experts, read deep insights, and ask questions,\nwhere knowledge meets fandom",
        },
      ...
      },
      {
        ...
        name_ko: "셔플업",
        desc: {
          ko: "오프라인 포커 대회, 이제 시스템으로 운영하세요.\n등록·중계·정산까지 하나의 솔루션으로 해결합니다",
          en: "Run offline poker tournaments with a proper system,\nregistration·broadcast·settlement — one solution",
        },
      ...
      },
      {
        ...
        name_ko: "GTO루루",
        desc: {
          ko: "AI GTO 솔버와 홀덤 솔버 위키가 한 곳에,\nGTO 분석·핸드 리뷰·레인지 시뮬을 체계적으로 학습",
          en: "An AI GTO solver paired with a Holdem Solver Wiki,\nGTO analysis·hand review·range sim — all in one place",
        },
  ...
  news: {
    ...
    items: [
      ...
      },
      {
        ...
        desc: { ko: "초청받은 선수만 오르는 프리미엄 무대.\n선수·팬·브랜드가 함께한 시즌 클로저.", en: "An invitation-only premium stage.\nPlayers, fans, and brand — season finale." },
        date: "2025.12",
