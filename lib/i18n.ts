...
export const content = {
  ...
  hero: {
    ...
    en: {
      ...
      sub: "Social poker, broadcast interactive mini-games,\nclubs and tournaments, knowledge platforms, AI solutions.\nWe connect every touchpoint where players gather.",
  ...
  axes: {
    ko: {
      label: "THREE AXES",
      headline: "세 개의 축, 하나의 커뮤니티",
      sub: "모이고, 머물고, 성장하는 경험을 세 축이 함께 만듭니다.",
      items: [
        {
          key: "game",
          color: "#e63946",
          name: "GAME",
          title: "모이는 접점",
          desc: "소셜 포커부터 방송 인터랙티브 미니게임까지, 즐거움으로 플레이어를 모읍니다.",
        ...
        },
        {
          ...
          name: "COMMUNITY",
          title: "머무는 공간",
          desc: "소모임 운영부터 대회 시스템까지, 플레이어가 오래 머무는 구조를 만듭니다.",
        ...
        },
        {
          ...
          name: "TECH",
          title: "성장의 기반",
          desc: "지식 교류와 AI 코칭으로 플레이어의 실력과 경험을 함께 키웁니다.",
    ...
    en: {
      label: "THREE AXES",
      headline: "Three axes, one community",
      sub: "Gather, stay, and grow. Three axes build the experience together.",
      items: [
        {
          key: "game",
          color: "#e63946",
          name: "GAME",
          title: "Where players gather",
          desc: "From social poker to broadcast interactive mini-games, we bring players together through play.",
          services: ["PokerLulu", "LinkPlay"],
        },
        {
          key: "community",
          color: "#ff8c42",
          name: "COMMUNITY",
          title: "Where players stay",
          desc: "From clubs to tournaments, we design a place where players settle in and stick around.",
          services: ["Moitto", "ShuffleUp"],
        },
        {
          key: "tech",
          ...
          desc: "Knowledge exchange and AI coaching raise every player's skill and journey.",
          services: ["TubeLuLu", "GTOlulu"],
        },
      ],
    },
