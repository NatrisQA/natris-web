    ...
    items: [
      {
        ...
        name_ko: "포커룰루",
        desc: {
          ko: "정식 등급분류 완료.\n소셜 포커, 대회 시스템, 실시간 중계, 토너먼트를 갖춘\n온라인 소셜 포커 플랫폼.",
          en: "Officially rated online social poker platform.\nFeaturing social poker, tournament system,\nlive broadcast, and tournament modes.",
        },
      ...
      },
      {
        ...
        desc: {
          ko: "BJ·크리에이터와 시청자가\n실시간으로 매칭되어 함께 즐기는\n인터랙티브 미니게임 플랫폼.",
          en: "Interactive mini-game platform\nwhere creators and viewers\nmatch in real-time to play together.",
        },
      ...
      },
      {
        ...
        name_ko: "모이또",
        desc: {
          ko: "호스트 중심의 소모임 운영 플랫폼.\n모집부터 멤버 관리, 포인트·랭킹,\n자동 정산, 멤버십까지 한 곳에서.",
          en: "Host-centric club management platform.\nRecruitment, member management, points & ranking,\nauto settlement, and membership — all in one place.",
        },
      ...
      },
      {
        ...
        name_ko: "투베루루",
        desc: {
          ko: "전문가를 구독하고,\n깊이 있는 인사이트를 읽고,\n직접 질문하는 지식기반 팬덤 교류 플랫폼.",
          en: "Subscribe to experts,\nread deep insights, and ask questions directly\n— a knowledge-based fandom exchange platform.",
        },
      ...
      },
      {
        ...
        name_ko: "셔플업",
        desc: {
          ko: "오프라인 포커 대회 운영을 위한 올인원 솔루션.\n등록·시딩·블라인드 관리·실시간 중계·자동 정산까지\n한 번에.",
          en: "All-in-one solution for offline poker tournament management.\nRegistration, seeding, blind management,\nlive broadcast, and auto settlement.",
        },
      ...
      },
      {
        ...
        name_ko: "GTO루루",
        desc: {
          ko: "AI 기반 GTO(Game Theory Optimal) 솔버.\n핸드 분석, 레인지 시뮬레이션, AI 코칭,\n전략 리포트를 하나의 툴에서.",
          en: "AI-powered GTO solver.\nHand analysis, range simulation, AI coaching,\nand strategy reports — all in one tool.",
        },
