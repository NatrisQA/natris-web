  ...
  products: {
    ...
    items: [
      ...
      },
      {
        ...
        name_ko: "모이또",
        desc: {
          ko: "호스트 중심의 소모임 운영 플랫폼. 모집부터 멤버 관리, 포인트·랭킹, 자동 정산, 멤버십까지 한 곳에서.",
          en: "Host-centric club management platform. Recruitment, member management, points & ranking, auto settlement, and membership — all in one place.",
        },
      ...
      },
      {
        ...
        name_ko: "셔플업",
        desc: {
          ko: "오프라인 포커 대회 운영을 위한 올인원 솔루션. 등록·시딩·블라인드 관리·실시간 중계·자동 정산까지 한 번에.",
          en: "All-in-one solution for offline poker tournament management. Registration, seeding, blind management, live broadcast, and auto settlement.",
        },
      ...
      },
      {
        ...
        name_ko: "GTO루루",
        desc: {
          ko: "AI 기반 GTO(Game Theory Optimal) 솔버. 핸드 분석, 레인지 시뮬레이션, AI 코칭, 전략 리포트를 하나의 툴에서.",
          en: "AI-powered GTO solver. Hand analysis, range simulation, AI coaching, and strategy reports — all in one tool.",
        },
