...
/* Fullpage slide preview v3 — v2 기반 + Hero 캡션 제거 시안
 *  v2 구조 그대로 상속 (compact / parallax / side-dot / axes shrink)
 *  추가: Hero 하단 캡션("모이고, 머물고, 성장하는 / 커뮤니티를 만듭니다") 숨김
 */
...
function useFullpageFlipV3(onChange: IdxChange) {
  ...
  return (
    ...
    >
      <span className="text-[11px] font-black tracking-[0.18em]" style={{ color: "#ff5a6a" }}>
        FULLPAGE PREVIEW v3 · Hero 캡션 제거 · {activeIndex + 1}/{SECTIONS.length} · {cur.label}
      </span>
...
function PageContent() {
  ...
  useFullpageFlipV3(setActiveIndex);

  return (
    <ScrollContainerCtx.Provider value={scrollRef}>
    <div data-fp-compact data-fp-v3>
      <style>{`
        /* Hero — pt-20/pb-20을 clamp로 전환 */
        ...
        /* v3 전용: HeroVisualE 하단 캡션 숨김
           ("모이고, 머물고, 성장하는 / 커뮤니티를 만듭니다") */
        [data-fp-v3] #hero .mt-10.text-center.tracking-tight { display: none; }
        ...
        /* Axes — padding clamp + 다이어그램 max-height */
        ...
        [data-fp-compact] #axes .fp-axes [style*="maxWidth: 880"] { max-width: 600px; }
        [data-fp-compact] #axes .fp-axes [style*="maxWidth: 880"] svg {
...
export default function FullpagePreviewV3Page() {
  return (
    <LangProvider>
      <PageContent />
    </LangProvider>
