...
export default function Footer() {
  ...
  return (
    ...
    >
      <div className="px-6 md:px-10 lg:px-16 xl:px-24 2xl:px-32 py-10">
        <div className="max-w-[1680px] mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          {/* Brand + links */}
